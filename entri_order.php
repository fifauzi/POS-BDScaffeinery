          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  $no_order_fiks = 1;
                  $query_order_fiks = "select * from tb_pesan natural join tb_menu where id_user = $id & status_pesan != 'sudah'";
    ...
    <div class="row-fluid">
                ...
                <ul>
                  ...
                  <?php
                    ...
                    while($r_dt_pesan = mysqli_fetch_array($sql_lihat_pesan)){
                      array_push($pesan, $r_dt_pesan['id_order']);
                    }

                    $query_data_makanan = "select * from tb_menu where stok > 0 order by id_menu desc";
                  ...
                  ?>
                      <li class="span2"> 
                        <a> <img src="gambar/<?php echo $r_dt_makanan['gambar_menu']?>" alt="" > </a>
                        <div class="actions">
                          <a class="lightbox_trigger" href="gambar/<?php echo $r_dt_makanan['gambar_menu'];?>"><i class="icon-search"></i>&nbsp;Lihat</a> 
                        </div>
                        <table class="table table-bordered">
                          <tbody>
                            <tr>
                              <td><?php echo $r_dt_makanan['nama_menu'];?></td>
                            </tr>
                            <tr>
                              <td>Harga / Porsi</td>
                        ...
                        <form action="" method="post">
                          <?php
                            if(in_array($r_dt_makanan['id_menu'], $pesan)){
                          ?>
                              <button type="submit" value="<?php echo $r_dt_makanan['id_menu'];?>" name="tambah_pesan" class="btn btn-danger btn-mini" disabled>
                                <i class='icon-shopping-cart'></i>&nbsp;&nbsp;Telah dipesan &nbsp;&nbsp;
                              </button>
                          <?php
                            } else {
                          ?>
                              <button type="submit" value="<?php echo $r_dt_makanan['id_menu'];?>" name="tambah_pesan" class="btn btn-success btn-mini">
                    ...
                    <?php
                      ...
                      if(isset($_REQUEST['tambah_pesan'])){
                        ...
                        $query_tambah_pesan = "insert into tb_pesan values('', '$id', '', '$id_menu', '', '')";
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
              <?php
                $query_draft_pesan = "select * from tb_pesan natural join tb_menu where id_user = $id and status_pesan != 'sudah'";
                $sql_draft_pesan = mysqli_query($conn, $query_draft_pesan);

                while($r_draft_pesan = mysqli_fetch_array($sql_draft_pesan)){
              ?>
                <tr class="odd gradeX">
                  <td><span id="<?php echo "nama".$r_draft_pesan['id_pesan']; ?>"><?php echo $r_draft_pesan['nama_menu'];?></span></td>
                  <input id="<?php echo "harga".$r_draft_pesan['id_pesan']; ?>" class="span8" type="hidden" value="<?php echo $r_draft_pesan['harga'];?>"/>
                  <td>
                    <center>
                      <input id="<?php echo "jumlah".$r_draft_pesan['id_pesan']; ?>" class="span8" name="jumlah<?php echo $r_draft_pesan['id_menu']; ?>" type="number" value="" placeholder="" onchange="return operasi()"/>
                    </center>
                  </td>
                  <td>
                    <form action="" method="post">
      ...
      <?php
          ...
          if(isset($_POST['proses_pesan'])){
            ...
            $query_ubah_jumlah = "select * from tb_pesan left join tb_menu on tb_pesan.id_menu = tb_menu.id_menu where id_user = $id and status_pesan != 'sudah'";
            ...
            while($r_ubah_jumlah = mysqli_fetch_array($sql_ubah_jumlah)){
              ...
              //echo $tempe;
              $query_proses_ubah = "update tb_pesan set jumlah = $tempe, id_order = $id_ordernya where id_menu = $tahu and id_user = $id and status_pesan != 'sudah'";
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; BDS POS <a href="#">by fifauzi</a> </div>
</div>
