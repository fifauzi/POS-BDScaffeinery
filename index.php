...
<html lang="en">
<head>
	<title>Masuk || BDS Caffeinery</title>
	<meta charset="UTF-8">
...
<body>
	<div class="limiter">
		<div class="container-login100" style="background-image: url('template/masuk/images/img1.jpeg');">
			<div class="wrap-login100 p-t-120 p-b-30">
				<form action="" method="post" class="login100-form validate-form">
					...
					<div class="login100-form-avatar">
						<img src="template/masuk/images/avatar1.png" alt="AVATAR">
					</div>
