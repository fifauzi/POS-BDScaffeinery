          ...
          <ul class="thumbnails">
            <div class="btn-icon-pg">
              <ul>
                <!--Looping-->
                <?php
                  $query_data_makanan = "select * from tb_menu order by id_menu desc";
                ...
                ?>
                    <li class="span2"> 
                      ...
                      <form action="" method="post">
                        <button type="submit" value="<?php echo $r_dt_makanan['id_menu'];?>" name="edit_menu" class="btn btn-success btn-mini"><i class='icon-pencil'></i>&nbsp;&nbsp;Edit &nbsp;&nbsp;</button>
                        <button type="submit" value="<?php echo $r_dt_makanan['id_menu'];?>" name="hapus_menu" class="btn btn-mini btn-danger"><i class='icon icon-trash'></i>&nbsp; Hapus</button>
                      </form>
                    </li>
                  <?php
                    }
                    if(isset($_REQUEST['hapus_menu'])){
                      ...
                      $query_lihat = "select * from tb_menu where id_menu = $id_menu";
                      ...
                      $query_hapus_menu = "delete from tb_menu where id_menu = $id_menu";
                      $sql_hapus_menu= mysqli_query($conn, $query_hapus_menu);
                      if($sql_hapus_menu){
