...
if(isset ($_SESSION['username'])){
  ...
  if(isset($_SESSION['edit_menu'])){
    ...
    $query_data_edit = "select * from tb_menu where id_menu = $id";
        ...
        <div class="widget-content" >
          <form action="" method="post" class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data">
            <div class="control-group">
              ...
              <div class="controls">
                <?php 
                  if(isset($_SESSION['edit_menu'])){
                ?>
                  <input name="" type="text" value="<?php echo $nama_menu; ?>" class="span11" placeholder="Nama Menu" disabled=""/>
                  <input name="nama_menu" type="hidden" value="<?php echo $nama_menu; ?>" class="span11" placeholder="Nama Menu"/>
                <?php
                  } else {
                ?>
                  <input name="nama_menu" type="text" value="" class="span11" placeholder="Nama Menu"/>
                <?php
                  }
                ?>
              </div>
            ...
            <div class="control-group">
              ...
              <div class="control-group">
                <div class="controls">
                  <img src="gambar/<?php echo $gambar_menu;?>" id="previewne" class="rounded border p-1" style="width:110px; height:70px;">
                </div>
              </div>
            </div>
          ...
          <?php
            if(isset($_POST['tambah_menu'])){
              ...
              //echo "<br></br>";
              $query_tambah_menu = "insert into tb_menu values ('','$nama_menu','$harga','$stok','$status_menu','$gambar')";
